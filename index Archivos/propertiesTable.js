...
ui.components.PropertiesTableView = Backbone.View.extend({
    ...
    setupElementTypeEditing: function () {
        ...
        if (this.model.isDependum && this.model.isDependum()) {
            ...
            _.forEach(dsm3.metamodel.nodes, function(nodeType, index) {
            ...
            this.$table.find('a').editable({
                ...
                success: function (response, newValue) {
                    ...
                    var newType = dsm3.metamodel.nodes[newValue].name;
                    updatedElement.prop('type', newType);
                    var newNode = dsm3.replaceNode(updatedElement, dsm3.metamodel.nodes[newValue].name)
            ...
            var element = this.model;
            var contributionMetamodel = dsm3.metamodel.nodeLinks.ContributionLink;
        ...
        if (ui.getSelectedCells()[0].remove) {
            ...
            $('#flip-direction-button').click(function () {
                ...
                if (dependum) {
                    ...
                    var isValid = dsm3.metamodel.dependencyLinks['DependencyLink'].isValid(target, source);//check with flipped source/target
