...
ui.components.createAddButtons = function() {
    ...
    if (dsm3.metamodel.containers) {
        _.forEach(dsm3.metamodel.containers, function (elementType) {
    ...
    if (dsm3.metamodel.containerLinks) {
        _.forEach(dsm3.metamodel.containerLinks, function(linkType) {
            //if specific ui elements are not defined, use default ones
    ...
    _.forEach(dsm3.metamodel.nodes, function(elementType) {
    ...
    _.forEach(dsm3.metamodel.nodeLinks, function(linkType) {
