...
joint.shapes.dsm3.DefaultContainer = joint.dia.Element.extend({
...
joint.shapes.dsm3.DefaultNode = joint.shapes.basic.Rect.extend({
...
joint.shapes.dsm3.DefaultContainerLink = joint.dia.Link.define('DefaultContainerLink',
    {
        attrs: {
            line: {
                connection: true,
...
joint.shapes.dsm3.DefaultNodeLink = joint.dia.Link.define('DefaultNodeLink',
    {
        attrs: {
            line: {
                connection: true,
